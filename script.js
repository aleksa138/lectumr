    ...
    files.forEach((file) => {
        ...
        div.innerHTML = `
            ...
            <div class="file-actions">
                ${!file.importedFrom ? `<button class="btn-sm" onclick="shareFile(event, '${file.id}')" title="Поделиться" aria-label="Поделиться">🔗</button>` : ''}
...
function previewFile(file) {
    ...
    if (file.type.includes('pdf')) {
        box.innerHTML = `<div style="color:white; text-align:center; padding: 20px;">
            <h3>📄 ${file.name}</h3><br>
